...
export const PALETTES: { id: string; label: string; ground: string; ink: string; colors: string[] }[] = [
  ...
  },
  {
    ...
    ground: '#ffffff',
    ink: '#0064e0',
    colors: ['#0064e0', '#25c8ee', '#ffd61e', '#ff4f00'],
  },
  {
    id: 'harmonious',
    label: 'Harmonious',
    ground: '#ffffff',
    ink: '#0064e0',
    colors: ['#0064e0', '#af4ec5', '#814dff', '#1ac5ed', '#5043ff'],
  },
  {
    id: 'atmospheric',
    label: 'Atmospheric',
    ground: '#ffffff',
    ink: '#0064e0',
    colors: ['#0064e0', '#d7e7ee', '#7ca0b7', '#53606A', '#1c2b33'],
  },
  {
    id: 'neutrals',
    label: 'Neutrals',
    ground: '#ffffff',
    ink: '#0064e0',
    colors: ['#0064e0', '#ffffff', '#dae3ea', '#8d9dac', '#53606A', '#1c2b32', '#000000'],
  },
]
